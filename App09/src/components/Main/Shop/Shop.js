...
import playgroundIconS from '../../../media/appIcon/playground.png';
import playgroundIcon from '../../../media/appIcon/playground0.png';
            ...
            <View style={{ flex: 1, backgroundColor: '#DBDBD8' }}>
                ...
                <TabNavigator>
                    ...
                    <TabNavigator.Item
                        ...
                        renderIcon={() => <Image source={playgroundIcon} style={iconStyle} />}
                        renderSelectedIcon={() => <Image source={playgroundIconS} style={iconStyle} />}
                        selectedTitleStyle={{ color: '#34B089', fontFamily: 'Avenir' }}
                    >
                        <Customer />
                    </TabNavigator.Item>
